...
import org.s.api.admin.dao.IXxlApiBizDao;
...
public class XxlApiProjectController {
	...
	@RequestMapping
	public String index(HttpServletRequest request, Model model, @RequestParam(required = false, defaultValue = "0") int bizId) {
		...
		// 权限
		model.addAttribute("hasBizPermission",  hasBizPermission(request, bizId));
