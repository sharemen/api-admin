...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/adminlte/plugins/menu/main.js"/>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
				...
				<a href="#">
				<i class="fa fa-dashboard"></i> <span>${biz.bizName}</span>
				...
				<li class="treeview">
				<a href="#">
				<i class="fa fa-circle-o"></i><span>${project.name}</span>
				<span class="pull-right-container">
				<i class="fa fa-angle-left pull-right"></i>
				</span>
				</a>
				...
				<ul class="treeview-menu">
					<li>
					<a href="#"><i class="fa fa-circle-o">{group.name}</i></a>
					</li>
				</ul>
				</#list>
				</li>
