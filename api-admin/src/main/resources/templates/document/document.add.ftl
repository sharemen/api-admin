        ...
        <section class="content">
            <form class="form-horizontal" id="ducomentForm" >
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <input type="text" class="form-control" name="wikiparenturl" id="wikiparenturl" placeholder="页面发布位置的父级url" maxlength="80" > 将也发布到指定父级 ,url格式：${wikihost!""}/pages/viewpage.action?pageId=11111111
                            </div>
                        ...
                        <label class="col-sm-1 control-label">wiki信息</label>
                        <div class="col-sm-11">
                                <input type="text" class="form-control" name="wikiurl" id="wikiurl" placeholder="指定接口对应的wiki页面url" maxlength="80" > 填写将会直接更新url对应的wiki，并忽略上级wiki页面url的给定值,url格式同上
                            </div>
                        </div>
                       <div class="form-group">
                    ...
                    <div id="needResource_example" style="display: none;" >
                        <div class="form-group needResource_item" >
                            ...
                            <div class="col-sm-4 item">
                                <input type="text" class="form-control name" placeholder="内部URL相对地址、后台函数、外部URL绝对地址" maxlength="400">
                            </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body" >
                        <div class="box-body pad" id="reqRemark" >
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content no-padding">
                        ...
                        <div class="chart tab-pane active" id="request_example" style="position: relative; height: 365px;">
                            <div class="box-body">
                                ...
                                <br>
                                <textarea name="requestExample" id="requestExample" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin-top: 15px;" ></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body" >
                        <div class="box-body pad" id="respRemark" ><textarea style="display:none;"></textarea></div>
                    </div>
                </div>
