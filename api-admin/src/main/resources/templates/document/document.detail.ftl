            ...
            <form class="form-horizontal" id="ducomentForm" >
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <#if document.wikiId?exists && document.wikiId gt 0 >
                        <div class="form-group">
                        <label class="col-sm-1 control-label">wiki信息</label>
                        <div class="col-sm-6">
                                
                                <a href="${wikihost}/pages/viewpage.action?pageId=${document.wikiId}" target="_blank" > ${wikihost}/pages/viewpage.action?pageId=${document.wikiId}</a>
                        ...
                        <#if needResourceList?exists>
                            <table class="table table-striped">
                                ...
                                <#list needResourceList as needResource>
                                    <tr>
                                    	<td>${needResource.type}</td>
                                        <td>${needResource.name}</td>
                                        <td>${needResource.desc}</td>        
                                    </tr>
                                </#list>
                            </table>
                        </#if>
                ...
                <#-- 请求参数说明 -->
                <#if document.reqRemark?exists && document.reqRemark?length gt 0 >
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">接口说明</h3>
                            <div class="box-tools pull-right">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content no-padding">
                        <!-- Morris chart - Sales -->
                        <div class="chart tab-pane active" id="success_example" style="position: relative; height: 100%;">
                            <div class="box-body">
                                <pre name="requestExample" class="jsonViewPre" style="width: 100%; height: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin-top: 15px;" >${document.requestExample!""}</pre>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <#-- 响应结果说明 -->
                <#if document.respRemark?exists && document.respRemark?length gt 0 >
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">响应结果说明</h3>
                            <div class="box-tools pull-right">
                            <button class="btn btn-default btn-xs" type="button" onclick="javascript:window.location.href='${request.contextPath}/group?projectId=${projectId}&groupId=${document.groupId}'" >返回接口列表</button>
                            <#if hasBizPermission>
                                <button class="btn btn-default btn-xs" type="button" onclick="javascript:window.location.href='${request.contextPath}/document/updatePage?id=${document.id}'" >修改接口</button>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding" >
                        <table class="table table-striped">
                            <tr>
                                <th style="width: 20%;" >响应数据类型(MIME)</th>
                            ...
                            <#list mockList as mock>
                                ...
                                <tr>
                                    <td>${mock.respType}</td>
                                    <td><#if mock.updateTime??>${mock.updateTime?string('yyyy-MM-dd HH:mm:ss')}<#else></#if></td>
                                    <td>
                                        ...
                                        &nbsp;
                                        <#if mock.isdefault == 0 >
                                        <a href="javascript:;" class="defaultMock" _id="${mock.id}" style="color:gray;" onmouseover="this.style.cssText='color:silver;'" onmouseout="this.style.cssText='color:gray;'"><i class="fa fa-fw fa-wrench"></i>设为默认</a>
                                        <#else>
                                        <b>默认</b>
                                        </#if>
                                    </td>
