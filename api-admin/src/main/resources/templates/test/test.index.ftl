            ...
            <form class="form-horizontal" id="ducomentForm" >
                        ...
                        <div class="form-group">
                            ...
                            <#if project?exists>
                                <div class="col-sm-2">
                                    ...
                                    <#if project.baseUrlDev?exists && project.baseUrlDev!="" >
                                        <option value="${project.baseUrlDev}${document.requestUrl}"
                                            <#if testHistory?exists && testHistory.requestUrl == (project.baseUrlDev + document.requestUrl)>selected</#if> >开发环境</option>
                                    </#if>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        &nbsp;&nbsp;<input type="checkbox" id="isRequestBody" value="1" ></input>用request body传输
                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="withTestToken" value="1" ></input>自动获取测试token调用<b><#if enableProdRun?exists && enableProdRun == "1">【生产环境接口测试功能已开启】<#else>【生产环境接口测试功能已关闭】</#if></b>
                        <input type="hidden" id="enableProdRun" value="${enableProdRun!""}" />
                        <div class="box-tools pull-right">
                            ...
                            <#list queryParams as item>
                                <div class="form-group queryParams_item" >
                                    ...
                                    <div class="col-sm-5 item">
                                        ...
                                        <input type="hidden" class="form-control valuetype" value="${item.type}" > 
                                    </div>
                                    <button type="button" class="col-sm-1 btn btn-box-tool delete" ><i class="fa fa-fw fa-close"></i></button>
                                </div>
                            </#list>
